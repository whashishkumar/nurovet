...
export default function HistoryCard({ year, image, alt, description }: any) {
  return (
    <div className="flex flex-col items-center max-w-md mx-auto font-sans p-6">
      {/* Year Bubble */}
      <div className="rounded-full border border-gray-300 px-8 py-4 text-3xl font-bold text-gray-900 shadow-sm">
        {year}
      </div>
